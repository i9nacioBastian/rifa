...
export default function SalesManager({
    ...
    return (
        <div className="glass-card rounded-3xl p-6 animate-fadeIn">
            ...
            {selectionMode && (
                <div className="mb-4 bg-blue-50 border-l-4 border-blue-500 p-3 rounded-lg animate-fadeIn">
            ...
            <div className="mb-4 mx-auto justify-center flex mt-4">
                <button
                ...
                >
                    ...
                    {selectionMode ? 'Cancelar asignación' : 'Marcar números vendidos'}
                </button>
            </div>
            {/* Sold Numbers List */}
                            ...
                            {soldNumbersList.length === 0 ? (
                                ...
                                soldNumbersList.map((sale) => (
                                    <tr key={sale.number} className="border-b border-gray-100 last:border-0">
                                        <td className="py-2 px-3 font-bold text-blue-600">{sale.number}</td>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-2">
                                <i className="fas fa-user mr-2 text-blue-600"></i>Nombre del Comprador *
                            </label>
                            <input
                                type="text"
                                value={buyerName}
                                ...
                                className="w-full px-4 py-2 rounded-lg border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition outline-none"
                            />
                        </div>

                        <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-2">
                                <i className="fas fa-phone mr-2 text-blue-600"></i>Teléfono (opcional)
                            </label>
                            <input
                                type="tel"
                                value={buyerPhone}
